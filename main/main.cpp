...
extern "C" void app_main(void) {
    ...
    xTaskCreatePinnedToCore(motorTask, "Motor task", 8192, NULL, 24, NULL, 1);
    xTaskCreate(gearbox_task, "Gearbox task", 8192, NULL, 24, NULL);
    ...
    // while (true) {
    //     ESP_LOGI(TAG, "motor x: %f, motor y: %f", motorX.shaft_angle, motorY.shaft_angle);
